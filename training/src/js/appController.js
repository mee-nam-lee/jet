  ...
  function (ko, moduleUtils, ResponsiveUtils, ResponsiveKnockoutUtils, Router, ArrayDataProvider, KnockoutTemplateUtils) {
    function ControllerViewModel() {
      ...
      self.router.configure({
        'login': { label: 'Login' , isDefault: ! self.login()  },
        'environment': { label: 'Environment',isDefault: self.login() },
      ...
      self.appName = ko.observable("Training Environment");
